...
sub usage_text{
    my $usage = <<EOF;
Usage:
cloudcmd disable [--cmd-opt] [cmd-arg]
...
example:
cloudcmd disable -i xxx account
cloudcmd disable -p account=heince,domainid=xxx -l account
